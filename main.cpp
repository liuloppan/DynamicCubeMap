...
// some basic glfw setups
GLFWwindow* createGlfwWindow()
{

    // glfw window creation
    // --------------------
    GLFWwindow* thisWindow = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "LearnOpenGL", NULL, NULL);
    if (thisWindow == NULL)
    {
...
int createShader(const char *thisVertexShaderSource, const char *thisFragmentShaderSource)
{
  // build and compile our shader program
    ...
    glShaderSource(vertexShader, 1, &thisVertexShaderSource, NULL);
    ...
    glShaderSource(fragmentShader, 1, &thisFragmentShaderSource, NULL);
